  ...
  return (
    <div className={sidebarClasses}>
      <div className="flex flex-col h-full">
        {/* Header */}
        <div className="h-16 shrink-0 flex items-center justify-between px-6 border-b border-slate-800 bg-slate-900/50">
        ...
        {/* Content - Flex Column to allow Notes to expand */}
          ...
          <div className="p-6 flex flex-col min-h-full">
            ...
            <div className="shrink-0 mb-6">
              <input
                ...
                className="w-full bg-transparent text-2xl font-bold text-white placeholder-slate-600 focus:outline-none border-none p-0"
                placeholder="Task Title"
              />
            </div>

            {/* Controls */}
            <div className="shrink-0 grid grid-cols-2 gap-4 mb-8">
            ...
            {/* AI Tools */}
            <div className="shrink-0 mb-6 p-4 rounded-xl bg-gradient-to-r from-indigo-500/10 via-purple-500/10 to-pink-500/10 border border-indigo-500/20">
            ...
            <div className="flex-1 flex flex-col min-h-[300px]">
              <label className="text-xs font-semibold text-slate-500 uppercase tracking-wider mb-2">Notes</label>
              <textarea
                value={editedTask.description}
                onChange={(e) => handleInputChange('description', e.target.value)}
                className="flex-1 w-full bg-slate-800/50 border border-slate-700 rounded-xl p-4 text-slate-300 placeholder-slate-600 focus:ring-2 focus:ring-blue-500 focus:border-transparent resize-none leading-relaxed font-mono text-sm"
